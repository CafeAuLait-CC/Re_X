...
#     xinput = _conv2D(16, 1, padding="same")(input)
#     a = _conv2D(16,3,padding="valid")(input)#148
#     a1 = _blocker(1,32)(a)
#     a2 = MaxPooling2D((2,2))(a1)#74
#     b = _conv2D(32,3,padding="valid")(a2)#72
#     b1 = _blocker(1,64)(b)
#     b2 = MaxPooling2D((2,2))(b1)#36
#     c = _conv2D(64,3,padding="valid")(b2)#34
#     c1 = _blocker(1,256)(c)
#     c2 = MaxPooling2D((2,2))(c1)#17
#     midl = _conv2D(512,10,padding="valid")(c2)#8
#     imid = _conv2DTran(256,10,padding="valid")(midl)#17
#     ic2 = UpSampling2D((2,2))(imid)#34
#     #ic2_a = Concatenate()([ic2,c1])#38
#     ic2_c1 = Add()([ic2,c1])#38
#     ic1 = _blocker(1,256)(ic2_c1)#38
#     ic = _conv2DTran(64,3,padding="valid")(ic1)#42
#     ib2 = UpSampling2D((2,2))(ic)#84
#     #ib2_a = Concatenate()([ib2,b1])#84
#     ib2_b1 = Add()([ib2,b1])#84
#     ib1 = _blocker(1,64)(ib2_b1)#84
#     ib = _conv2DTran(32,3,padding="valid")(ib1)#88
#     ia2 = UpSampling2D((2,2))(ib)#176
#     #ia1_a = Concatenate()([ia1,a])#176
#     ia2_a1 = Add()([ia2,a1])#176
#     ia1 = _blocker(1,32)(ia2_a1)
#     ia = _conv2DTran(16,3,padding="valid")(ia1)#200
